...
insert into item(itemName, price, inventory, image, itemDescription) values
    ...
    ('Blueberries', 4.99, 20, 'brandon-wilson-2eFgPIEoBsA-unsplash.jpg', 'Farm Fresh Blueberries'),
    ('Eggs', 2.99, 60, 'modernista-magazine-6AlvscWa3bA-unsplash.jpg', 'Cage-free brown eggs'),
    ('Bread', 5.99, 10, 'andrew-wong-59zgPU1aTgY-unsplash.jpg', 'Artisan Bread'),
    ('Asparagus', 6.99, 30, 'joah-brown-0_tdkFGWTGE-unsplash.jpg', 'locally grown asparagus'),
    ('Salmon', 10.99, 20, 'caroline-attwood-kC9KUtSiflw-unsplash.jpg', 'Wild Caught Alaskan Salmon'),
    ('Bell Pepper', 3.99, 10, 'midmidma-Abef-cCJMiU-unsplash.jpg', 'Organic Red Bell Peppers'),
    ('Oranges', 4.99, 40, 'melodee-uribe-cKQhTx1EV3o-unsplash.jpg', 'Florida oranges'),
